...
const RenderCards = ({ data, title}) => {if(data?.length > 0) {return data.map((post) => <Card key={post._id} {...post} />)}
  return (
...
const Home = () => {
  ...
  useEffect(() =>{
    const fetchPosts = async() => {
      setLoading(true)
      try {
        const response = await fetch('https://dall-e-wbl3.onrender.com/api/v1/post', {
          method:"GET",
          headers:{
